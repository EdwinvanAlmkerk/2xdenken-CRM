...
function fromDB_dossier(r)  { return { id: r.id, schoolId: r.school_id, contactId: r.contact_id, datum: r.datum, tekst: r.tekst, bronNaam: r.bron_naam || '', bijlagen: r.bijlagen || [] }; }
...
function toDB_dossier(d)  { return { school_id: d.schoolId, contact_id: d.contactId || null, datum: d.datum, tekst: d.tekst, bron_naam: d.bronNaam || null }; }
