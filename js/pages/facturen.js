...
// Logo is als base64 embedded zodat het altijd werkt, onafhankelijk van DOM/netwerk
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .brand-logo img{height:64px;width:auto;object-fit:contain;display:block;background:#fff}
...
<div class="page">
  ...
  <div class="header">
    <div class="brand-logo">
      <img src="${LOGO_BASE64}" alt="2xdenken logo"/>
    </div>
